...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const monthBackgrounds = [
    "url('background-images/january.jpg')",
    "url('background-images/february.jpg')",
    "url('background-images/march.jpg')",
    "url('background-images/april.jpg')",
    "url('background-images/may.jpg')",
    "url('background-images/june.jpg')",
    "url('background-images/july.jpg')",
    "url('background-images/august.jpg')",
    "url('background-images/september.jpg')",
    "url('background-images/october.jpg')",
    "url('background-images/november.jpg')",
    "url('background-images/december.jpg')",
  ];
  ...
  entryForm.onsubmit = function (e) {
    ...
    addEntry(
      ...
      currentMonth,
      currentYear,
      entryInput.value + " @ " + entryInputTime.value
    );
